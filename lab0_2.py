...
#     bi_values = backward_induction(maze=maze, states=states, rewards=rewards, t_horizon=t_horizon, plot=False, pause_time=0.5)
...
# plot_most_rewarding_policy(states=states, values=pi_values, n=n_iterations, algorithm='Policy Iteration')
